...
Tablestudio works with structured data. Let's import a sample dataset:
...
<Info>
  Tablestudio supports CSV, Excel, and API imports. For details, see [Importing
...
- **Support**: Email us at support@tablestudio.ai
